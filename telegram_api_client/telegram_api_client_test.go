...
func TestGetWebhookInfo(t *testing.T) {
	...
	t.Run("200 OK on correct token", func(t *testing.T) {
		// --- given --------
...
func TestSetWebhook(t *testing.T) {
	...
	t.Run("400 bad request on no-HTTPS support", func(t *testing.T) {
		// --- given --------
	...
	t.Run("200 OK was set", func(t *testing.T) {
		// --- given --------
	...
	t.Run("200 OK already set", func(t *testing.T) {
		// --- given --------
